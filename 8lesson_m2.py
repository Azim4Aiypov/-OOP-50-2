...
add_user("Ardager", 26, "плавать")
add_user("Oleg", 25, "плавать")
...
def get_average_grade():
    cursor.execute('SELECT AVG(grades.grade) FROM grades')
...
def get_users_with_highets_grade():
    cursor.execute('''
...
def get_young_users():
    ...
    print('Ьолодые пользователи до 25 лет !')
    for i in users:
